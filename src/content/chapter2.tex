...
seien nur einige genannt. Als Alternative zu dem properitären SCCS folgte Anfang 1980 das von
Walter F. Tichy an Purdue University entwickelte erste \acrlong{OpenSource}
Versionskontrollsystem \gls{rcs}\cite{paper:rcs,link:rcs}. Ross Ridge schrieb
1993 einen Ersatz für SCCS.  Alle dreiSysteme finden sich in der Praxis nur
noch sehr selten und daher wird an dieser Stelle nicht weiter auf diese Systeme
eingegangen. 
\subsection{CSV}
\subsection{SVN}
\subsection{Weitere}
