...
wird mit dem \textit{Secure Hash Algotithm} (SHA-1)
...
\begin{figure}[hb]
  ...
  \caption{Zusammenführen von zwei Branches}
  \label{fig:merge}
\end{figure}
...
\textit{octopus-merges}. Git ermöglicht es auch Zeige aus verschiedenen
...
werden\cite[S.~123]{gitwk}. Eine vergleichbare Vorgehensweise findet man im
