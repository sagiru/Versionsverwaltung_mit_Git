...
\subsubsection{Erstellen eines Klons}
...
einzelne \glspl{commit} aufzuteilen oder bestimmte Änderungen
...
erzwingen werden. Ein entfernen von Dateien aus dem Repository kann aber
genauso mit Unix üblichen Mitteln vorgenommen werden. Die Änderungen müssen
dann mit \texttt{add} hinzugefügt werden.\cite[S.~43-44]{gitosp}
