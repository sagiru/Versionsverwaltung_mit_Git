...
Eigenschaften von Versionskontrollsystemen eingegangen. Ebenso werden
...
wird zum Abschluss das Projekt vorgestellt, für das Git ursprünglich entwickelt
wurde - Der Linux Kernel.

Insgesamt gibt diese Arbeit einen ersten Einblick in den Einsatz von Git. Sie
verdeutlicht, warum Versionskontrollsysteme essenziell f\"ur den Einsatz in
erfolgreichen Softwareprojekten sind.
\end{abstract}
