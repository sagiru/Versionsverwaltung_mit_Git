...
\newglossaryentry{git}{
  name=Git,
  description={
    Siehe Abschnitt \ref{cha:git} auf Seite \pageref{cha:git}.
  }
}
...
\newglossaryentry{HEAD}{
  name=HEAD,
  description={
    Siehe Abschnitt \ref{sec:head} auf Seite \pageref{sec:head}.
  }
}
...
\newglossaryentry{ssh}{
  name=SSH,
  description={
    SSH steht für Secure Shell und ermöglicht eine Verbindung zu einem
    entfernten Rechner mittels des gleichnamigen Protokoll.  
  }
}
