...
\newglossaryentry{tag}{
  ...
  description={
    ...
    innerhalb eines Repositories. Wird i.d.R. für Releases oder Versionen
...
\newglossaryentry{commit}{
  name=Commit,
  description={
    Stellt einen eindeutigen Stand des Repositories dar. Enthält i.d.R.
...
\newglossaryentry{branch}{
  ...
  description={
    ...
    eines Repositories. \textbf{Abschnitt \ref{sec:branch}}
  }
}
...
\newglossaryentry{sha}{
  ...
  description={
    Wird durch \acrshort{sha1} abgekürzt und ist ein für kryptografische Zwecke
...
\newglossaryentry{HEAD}{
  name=HEAD,
  description={
    Eine Referenz auf einen letzten/neuesten Commit eines Branches/Repositories.
...
\newglossaryentry{repourl}{
  name=Repository-URL,
  description={
    Zieladresse des Repositories. Enhält Informationen über die Zugriffsmethode,
    Zugriffsparameter und den Ort des Repositories \cite[S.~141]{gitosp}
  }
}
